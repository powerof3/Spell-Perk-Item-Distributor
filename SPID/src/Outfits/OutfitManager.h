...
namespace Outfits
{
	...
	private:
		...
		HOOK_HANDLER_ALIAS(FilterInventoryItemsAE1130, FilterInventoryItems)
		HOOK_HANDLER_ALIAS(FilterInventoryItems3AE1130, FilterInventoryItems)
		HOOK_HANDLER_ALIAS(FilterInventoryItems2AE1130, FilterInventoryItems)
